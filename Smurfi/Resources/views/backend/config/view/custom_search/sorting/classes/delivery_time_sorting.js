...
//{block name="backend/config/view/custom_search/sorting/classes/delivery_time_sorting"}

Ext.define('Shopware.apps.Config.view.custom_search.sorting.classes.DeliveryTimeSorting', {
    ...
    supports: function (sortingClass) {
        return sortingClass == 'Smurfi\\SearchBundle\\Sorting\\DeliveryTimeSorting';
    },
            ...
            comp = Ext.create('Shopware.apps.Config.view.custom_search.sorting.includes.CreateWindow', {
                ...
                items: [{
                    ...
                    getAscendingLabel: function () {
                        return '{s name="delivery_time_asc"}{/s}';
                    },
                    getDescendingLabel: function () {
                        return '{s name="delivery_time_desc"}{/s}';
                    }
                }],
    ...
    createRecord: function (parameters) {
        return {
            'class': 'Smurfi\\SearchBundle\\Sorting\\DeliveryTimeSorting',
            'label': parameters.direction.toLowerCase() === 'desc' ? '{s name="delivery_time_desc"}{/s}' : '{s name="delivery_time_asc"}{/s}',
